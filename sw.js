...
const PRECACHE_ASSETS = [
  ...
  './images/products/Ultra_Green.png',
  './images/products/Amino_Power.png',
  './images/products/Amino16.png',
  './images/products/Amino_Cell_Antistress.png',
  './images/products/Amino_16_BZn.png',
  './images/products/Fruitfix.png',
  './images/products/Granbrix.png',
  './images/products/MicroRS.png',
  './images/products/NF_Hyd1.png',
  './images/products/BMC_Fixer.png',
  './images/products/Amino_Cell_S.png',
  './images/products/Amino_Cell_PK.png',
